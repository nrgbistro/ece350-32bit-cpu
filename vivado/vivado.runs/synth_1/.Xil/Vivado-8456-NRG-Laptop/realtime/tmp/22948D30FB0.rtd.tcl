...
set genomeRtd $env(RT_TMP)/22948D30FB0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__4101_RAM}]"
...
set genomeName [subst -nocommands -novariables {muxpart__4101_RAM}]
